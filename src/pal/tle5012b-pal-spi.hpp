...
class Tle5012b::SPI
{
    public:
         ...
         * @retval  INIT_ERROR if hardware interface error
         */
        virtual  HallSwitch::Error_t         write   () = 0;
         ...
         * @retval      INIT_ERROR if hardware interface error
         */
        virtual  HallSwitch::Error_t         transfer (uint16_t* sent_data, uint16_t size_of_sent_data, uint16_t* received_data, uint16_t size_of_received_data) = 0;
